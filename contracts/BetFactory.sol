...
contract BetFactory is Ownable{
  ...
  function getAllBetsTiles () public view returns (string memory) {
    ...
    for (uint i=0; i<bets.length; i++) {
      ...
      betTiles = append(betTiles,'"><span class="image"><img src="images/pic0');
      betTiles = append(betTiles,m);
      betTiles = append(betTiles,'.jpg"/></span><a href="#bettingSection"><h2>');
      betTiles = append(betTiles,bets[i].GetName());
      betTiles = append(betTiles,'</h2><div class="content"><p><li>Opcion A: ');
